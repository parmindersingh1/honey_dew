...
<div class="paneMid"> 
           <ul class="sf-menu">            
            <li class="category_item"><a href="#" id="home">Home</a></li>    
     	    <li class="category_item"><a href="#" >Contact</a></li>  
	    <li class="category_item"><a href="#content" id="home">Skip to Main Content</a></li>
	    <li class="category_item"><a href="#"  onclick="resizeText(-1)">A-</a></li>
	    <li class="category_item"><a href="#" onclick="resizeText(0)">A</a></li> 
            <li class="category_item"><a href="#" onclick="resizeText(1)">A+</a></li>     	
        </ul>
 </div>
<div class="paneRight"> </div>
 </div>
<!-- END CATEGORY MENU -->
...
<div id="header">
 <div id="blogtitle">
       <h1><a href="<?php echo get_option('home'); ?>/"><img class="logo" src="<?php bloginfo('template_directory'); ?>/images/logo5.png" alt="<?php bloginfo('sitename'); ?>" /></a></h1>
