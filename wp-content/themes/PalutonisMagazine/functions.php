...
function chilli_script()
{
   wp_enqueue_script('my-custom-script2', get_template_directory_uri() . '/js/chillbox-packed.js',array('jquery'),'1.0',true);
}
add_action('wp_enqueue_scripts','chilli_script');
?>
